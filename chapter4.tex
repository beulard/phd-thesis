...
% How does discriminator process wire?
    % One-hot encoding, softmax probabilities, differentiability
...
\begin{table}[]
    ...
    \toprule
        Sequence length & Parameters & Loss &    Optimiser & Learning rate & $\lambda_\mathrm{GP}$ \\
         & \begin{tabular}{cc} $D$ & $G$ \end{tabular} & & & & \\\midrule
        512 & \begin{tabular}{c|c} \numprint{687601} & \numprint{699213}\end{tabular} &
        WGAN-GP & Adam & $10^{-4}$ & 10 \\\bottomrule
    \end{tabular}
