...
samples~\cite{10.5555/3295222.3295408}. Conventionally, a pre-trained Inception
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{chapter4/cnn_fid-epoch.pdf}
    \caption{ Fréchet Inception Distance computed by the domain-specific 3D CNN
        over training epochs of the CDC GAN.}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{chapter4/tr_learning-epoch.pdf}
    \caption{ Fréchet Inception Distance computed by the transfer learning
        Inception v3 network over training epochs of the CDC GAN.}
    \label{fig:transfer_learning_FID_vs_epochs}
\end{figure}

\subsubsection{Interpretation of the FID}
...
(UMAP)~\cite{umap} to optimally project the feature vectors onto two dimensions.
