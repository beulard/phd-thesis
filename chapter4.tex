...
\sepfootnotecontent{A}{ Also called earth mover's distance, Wasserstein distance
...
\sepfootnotecontent{B}{ A function is 1-Lipschitz continuous if its
...
propose that the Wasserstein-1 distance\sepfootnote{A} between $p$ and $g$
...
1-Lipschitz continuous\sepfootnote{B}, then the adversarial training problem can
be formulated as:
\begin{equation}
    \min_G \max_D \quad
...
As discussed by \citeauthor{NIPS2017_892c3b1c}~\cite{NIPS2017_892c3b1c}, one
