...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{chapter2/pion_momentum_forward_backward.pdf}
...
\begin{figure}
    ...
    \caption{ Cutaway 3D view of the Phase-I transport solenoid. The curved
        ...
        making them drift vertically, combined with collimators (shown in teal)
        \hl{Correct?}. }
...
shape combined with its magnetic field and collimators eliminate unwanted
high-momentum and positively charged particles. 

The longitudinal field generated by a curved solenoid is not sufficient to guide
charged particles through the curved pipe. An additional vertical dipole field
is required to make the beam drift horizontally along the curve. The total field
inside the pipe is the vector sum of the curved solenoid field and this dipole
field.
...
\begin{equation*}
    D = \frac{1}{q B} \frac{s}{R} \frac{p^2_L + 0.5 p^2_T}{p_L},
\end{equation*}
...
Figure~\ref{fig:drift} shows drift as a function of $s$, the distance travelled,
for three values of momentum, assuming the same pitch angle. This illustrates
how, by having collimators at the top and bottom of the beam pipe, particles
with a momentum outside the required range can be efficiently eliminated.

% TODO drift with the addition of the dipole field: what is the total
% displacement of a particle as a function of $s$? That'd be nice.
