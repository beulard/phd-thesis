...
sensitivity} (SES), which indicates the value of the $\mu$--$e$
conversion branching ratio for which COMET expects to observe one event. Using
...
system. The signal acceptance can be broken down into seven efficiency factors:
geometrical acceptance, trigger efficiency, data acquisition (DAQ) efficiency,
track finding efficiency, track reconstruction quality cuts, momentum window
efficiency and trigger time window efficiency. Table~\ref{tab:acceptance} lists
these factors as they were estimated in the COMET Phase-I TDR~\cite[Section
10.1]{the_comet_collaboration_comet_2020}.

% This does not fit here... Should we have a section on acceptance?
% Events that contain a signal-like track are subject to quality cuts based on how
% accurately the trajectory was reconstructed. Overall, the track quality cuts retain
% \SI{70}{\percent} of candidate events.
...
\begin{table}
    ...
    \begin{tabular}{l|ccccccc|c}
        \toprule
        Factor & Geometrical & Trigger & DAQ & Track-finding & Cuts & Momentum
        & Timing & Net
        \\ 
        Efficiency & \SI{26}{\percent} & \SI{90}{\percent} & \SI{90}{\percent} &
    ...
    is the product of all efficiency factors. ``Cuts'' refers to track
    quality cuts, used to reject events with irregular tracks that cannot
