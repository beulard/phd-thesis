...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{chapter2/transport_solenoid.pdf}
    \caption{ Muon stopping target. }
    \label{fig:muon_stopping_target}
\end{figure}
...
than \SI{200}{\ns}, which would be too short to allow muons to convert after the
beam flash. Hence, a light target such as aluminium, with a longer stopped muon
lifetime of \SI{864}{\ns}, is better suited to the COMET conversion search.

\section{Detector systems}
\subsection{StrECAL}
The StrECAL combines a straw-tube tracker with an electromagnetic calorimeter.
