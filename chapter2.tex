...
described in more detail throughout of this chapter.
...
\begin{figure}
    ...
    \centering
        ...
        \vspace{3cm}
        \caption{Phase\nobreakdash-I with the Cylindrical Detector.}
    \end{subfigure}
    \hfill
...
\begin{figure}
    ...
    \caption{ Timeline of a COMET event. Shortly after the proton collision, the
        ...
        stopping target. The Phase\nobreakdash-I trigger window shown here starts at
        $t=\SI{700}{\ns}$ and lasts until the next proton bunch collision.
        Electron tracks with a momentum around \SI{105}{\MeV/\clight} observed
        within this timing window are considered as signal candidates. }
...
\begin{figure}
    ...
    \caption{ Cutaway view of the Phase\nobreakdash-I transport solenoid. The curved
...
\begin{figure}
    ...
    \caption{ Effective drift of particles of various momenta and either charge
        as they progress along the Phase\nobreakdash-I transport solenoid, calculated using
...
The Straw Tracker uses long, thin-walled PET tubes as gaseous drift chambers.
The tubes are first arranged into circular planes, four of which constitute a
station. Each station is able to measure the horizontal and vertical position of
a particle and has a spatial resolution of \SI{120}{\um}. Using time-of-flight
information, the Straw Tracker can therefore reconstruct trajectories and
estimate particle momenta.
...
\begin{table}
    ...
    COMET Phase\nobreakdash-I TDR~\cite{the_comet_collaboration_comet_2020}. The net
...
for a Phase\nobreakdash-I SES of $3 \times 10^{-15}$.
