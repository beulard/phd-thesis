...
To fulfil these roles, ICEDUST is divided into specialised packages. Fig.~\ref{fig:icedust_schematic} shows the flow of real and simulated data within the ICEDUST framework, and lists the names of the key packages.
...
\subsection{Intermediate simulation file format}\label{subsec:RT}
