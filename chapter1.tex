...
to a down quark). The fact that this occurs only rarely is explained by the GIM
mechanism: interference between diagrams with different flavours of mediating
quarks causes the branching ratio of FCNC to be heavily
suppressed~\cite{PhysRevD.2.1285}.
...
Figure~\ref{fig:lepton_fcnc} become allowed. These provide the only known way that
...
the process shown in Figure~\ref{fig:mu_e_nu_osc} to occur, which gives rise to a
