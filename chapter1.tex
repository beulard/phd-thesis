...
% Perhaps have an introduction before chap. 1, so we can introduce concepts softly and then get into the details starting from chapter 1.

% The very start of this chapter should introduce HEP concepts like the muon and what it is, how it relates to the SM, what is the SM.
This thesis concerns itself with addressing some of the challenges faced in the simulation of particles within the experimental setup of the COMET experiment.  % expand?
