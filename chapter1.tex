...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{chapter1/clfv_upper_limit_v2.pdf}
    \caption{
    ...
    tabulated by \citeauthor{BERNSTEIN201327}~\cite{BERNSTEIN201327}. Future
    data points are the expected sensitivities quoted in the MEG
    II~\cite{Baldini2018}, Mu3e~\cite{ARNDT2021165679}, COMET
...
\begin{figure}
    ...
    \caption{ Momentum distribution of reconstructed signal and decay-in-orbit
        ...
        $3.1\times 10^{-15}$. A momentum resolution of
