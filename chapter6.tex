...
simulation study for COMET Phase\nobreakdash-I. In this chapter, we discuss our simulation
samples consisting of signal, decay in orbit (DIO), and atmospheric events, and
present our resulting expectations of the performance of Phase\nobreakdash-I.
...
\begin{figure}
    ...
    events around the conversion energy, integrated over the Phase\nobreakdash-I run time
