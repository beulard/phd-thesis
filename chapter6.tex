...
% Cherenkov counters identify particle types via the Cherenkov threshold of the
% material. By carefully choosing the index of refraction of the material, it is
% possible to differentiate an electron from a muon with the same momentum,
% because the lighter electron will 
