...
% How do we say: we didn't simulate everything. For the stuff we didn't
% simulate, we apply TDR efficiency factors to the sample weight to account for them.
...
\hl{ Review this and compare with Selection section of Signal sample. Eliminate
    redundancies.}
